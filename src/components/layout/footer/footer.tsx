  ...
  return (
    <footer className="w-full bg-[var(--preto)] text-white py-8 md:py-12 lg:py-16">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="w-full flex flex-col lg:flex-row gap-8 md:gap-10 lg:gap-12 mb-6 md:mb-8">
          ...
          <div className=" w-full lg:w-auto max-w-[300px]">
            ...
            <p className="text-[var(--cinza-2)] text-xs md:text-xs leading-relaxed max-w-md ">
