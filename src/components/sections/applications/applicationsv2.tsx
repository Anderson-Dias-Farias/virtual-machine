    ...
    <section className="w-full py-[60px] relative">
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="bg-[var(--azul)] pt-8 px-4 rounded-[40px] relative overflow-hidden shadow-[0px_10px_40px_0px_rgba(0,0,0,0.1)]">
            {/* Background Image */}
            {bannerSrc && (
              <Image
                src={bannerSrc}
            ...
            <div className="relative z-10 p-8 md:p-12">
              <h2 className="text-2xl md:text-3xl font-semibold text-white mb-12 text-center leading-[1.5em]">
                {title}
              </h2>
